...
<div class="container mt-5">
    @auth
            @if(auth()->user()->Privilage_status === 'admin')
                    ...
                    <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#addEmployeeModal">
                    ...
                    <main class="container mt-5">
                        ...
                        <!-- Employees Table -->
                        <section>
                            <table id="employeeTable" class="table table-striped table-hover text-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="contact_no1" name="contact_no1" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="contact_no2" name="contact_no2" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
