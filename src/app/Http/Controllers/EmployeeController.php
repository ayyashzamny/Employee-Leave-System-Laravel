...
class EmployeeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.employee', compact('departments', 'designations'));
    }
    ...
    {
        $employee = Employee::findOrFail($id); // Assuming Employee model and 'id' field
